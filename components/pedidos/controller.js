...
function pagoElectronico(body, tipoPago, cliente) {
  ...
  const documentoIdentidadComprador = cliente.ci ? cliente.ci : "0000000";
                    ...
                    if (err) {
                      ...
                      const mdd = {
                        entry: [
                          ...
                          {
                            key: "merchant_defined_data16",
                            value: "Suc - 01, Calero #148",
                          },
                          {
                          ...
                          },
                          {
                            ...
                            value: "https://www.fribar.bo/pago-seguro",
                          },
                          ...
                          },
                          {
                            ...
                            value: cliente.ci ? cliente.ci : "0000000PT",
                          },
                          {
